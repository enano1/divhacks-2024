"""
Django settings for divhacksproject project.
...
SECRET_KEY = 'django-insecure-gn$8%%02q7=cm%q=lmja5(aa4h@tsij#o0^f8idgsvxj^-8xq$'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*', 'https://divhacks-2024.vercel.app/',]
...
ROOT_URLCONF = 'divhacksproject.urls'
...
WSGI_APPLICATION = 'divhacksproject.wsgi.application'
